...
namespace IRToolTrack
{
    public class IRToolController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            */
            //targetPosition = Quaternion.Inverse(cam_offset.rotation) * targetPosition + cam_offset.position;
            //targetRotation = Quaternion.Inverse(cam_offset.rotation) * targetRotation;
